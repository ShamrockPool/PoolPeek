...
class BisonPoolsV2 extends React.Component {
  state = {
    pools: null,
    loading: true,
    totalPools: '',
            ...
            <Row>
              ...
              <Col lg={4} md={12} sm={12} xs={12} className="mb-3">
                ...
                <Row style={{
                  ...
                  <p>More info on RISO: <a href='https://bisoncoin.io/' target="_blank" rel="noreferrer" ><b>HERE</b></a></p>
                </Row>
                ...
                <Col style={{
                  ...
                  <a href='https://discord.gg/6nZh34ZBkH' target="_blank" rel="noreferrer" >
                    <p>Bison Discord</p> <FontAwesomeIcon size="2x" icon={faDiscord} /> </a>
                </Col> */}
              </Col>
